...
Files: macbook-14.glb [629.72KB] > /Users/MAC/Documents/macbook-landing-gsap/public/models/macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        if (!noChangeParts.includes(child)) {
